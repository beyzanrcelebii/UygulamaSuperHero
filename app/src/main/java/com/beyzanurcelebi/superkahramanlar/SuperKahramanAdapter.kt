...
import com.beyzanurcelebi.superkahramanlar.databinding.RecyclerRowBinding
...
class SuperKahramanAdapter(val superKahramanListesi : ArrayList<SuperKahraman>): RecyclerView.Adapter<SuperKahramanAdapter.SuperKahramanViewHolder>() {
    ...
    override fun getItemCount(): Int { //listemin icinde ne varsa o kadar gostermek istiyorum
